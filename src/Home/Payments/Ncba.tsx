    ...
    return (
        <View>
            <View style={HomeCss.introCard}>
                ...
                <Text className='font-[gothici-Regular] mb-1'>4. Input <Text className='font-[gothici-Bold]'>{data.quotationNo}</Text> in the field labelled <Text className='font-[gothici-Bold]'>"Debit Note or Quote Number"</Text> and click <Text className='font-[gothici-Bold]'>"Validate"</Text></Text>
